...
package com.naji.memecreator.meme_editor.data
...
import com.naji.memecreator.meme_editor.presentation.util.MemeRenderCalculator
import com.naji.memecreator.meme_editor.presentation.util.ScaledMemeText
...
actual class PlatformMemeExporter : MemeExporter {
    ...
    private fun drawText(context: CGContextRef, memeText: ScaledMemeText) {
        ...
        val boundingRect = textNS?.boundingRectWithSize(
            size = CGSizeMake(memeText.constraintsWidth.toDouble(), CGFloat.MAX_VALUE),
            options = 1L shl 0,
        ...
        val textCenteringOffset = (memeText.constraintsWidth - textWidth) /2f
        ...
        textNS.drawWithRect(
            rect = CGRectMake(0.0, 0.0, memeText.constraintsWidth.toDouble(), textHeight.toDouble()),
            options = 1L shl 0,
            attributes = attributes,
            context = null
        )
