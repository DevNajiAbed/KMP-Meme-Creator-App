package com.naji.memecreator.meme_editor.presentation.components
...
import com.naji.memecreator.meme_editor.presentation.MemeEditorAction
import com.naji.memecreator.meme_editor.presentation.MemeText
import com.naji.memecreator.meme_editor.presentation.TextBoxInteractionState
...
fun DraggableContainer(
    ...
    // To convert from Px to Dp or Dp to Px
    ...
    BoxWithConstraints(modifier) {
        ...
        children.forEach { child ->
            ...
            val transformableState = rememberTransformableState { scaleChange, panChange, rotationChange ->
                ...
                val angle = newRotation * PI.toFloat() / 180
                val cos = cos(angle)
                val sin = sin(angle)
                ...
                val maxY = parentHeight - childHeight - scaledHeight - rotationOffsetY
